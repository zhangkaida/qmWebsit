...
app.config(["$routeProvider",function($routeProvider){
    ...
    .when("/file1",{templateUrl:"dream/dfile_1.html"})
    .when("/file2",{templateUrl:"dream/dfile_2.html"})
    .when("/file3",{templateUrl:"dream/dfile_3.html"})
    .when("/file4",{templateUrl:"dream/dfile_4.html"})
    .when("/file5",{templateUrl:"dream/dfile_5.html"})
